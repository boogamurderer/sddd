...
function library:Watermark(text)
    ...
    edge.BackgroundColor3 = Color3.fromRGB(35, 35, 48)
    ...
    bar.BackgroundColor3 = Color3.fromRGB(66, 109, 135)
    ...
    backgroundGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(35, 35, 48)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(66, 109, 135))}
...
function library:Introduction()
    ...
    xsxLogo.ImageColor3 = Color3.fromRGB(66, 109, 135)
    ...
    hashLogo.ImageColor3 = Color3.fromRGB(66, 109, 135)
...
function library:Init(key)
    ...
    function TabLibrary:NewTab(title)
        ...
        page.ScrollBarImageColor3 = Color3.fromRGB(66, 109, 135)
        page.Visible = false
        ...
        if TabLibrary.IsFirst then
            page.Visible = true
            tabButton.TextColor3 = Color3.fromRGB(66, 109, 135)
        ...
        tabButton.MouseButton1Click:Connect(function()
            ...
            TweenService:Create(tabButton, TweenTable["tab_text_colour"], {TextColor3 = Color3.fromRGB(66, 109, 135)}):Play()
        end)
        ...
        function Components:NewButton(text, callback)
            ...
            button.MouseEnter:Connect(function()
                TweenService:Create(button, TweenTable["hover"], {BackgroundColor3 = Color3.fromRGB(35, 35, 48)}):Play()
            end)
            ...
            button.MouseButton1Down:Connect(function()
                TweenService:Create(buttonLabel, TweenTable["hover"], {TextColor3 = Color3.fromRGB(66, 109, 135)}):Play()
            end)
        ...
        function Components:NewSection(text)
            ...
            rightBar.BackgroundColor3 = Color3.fromRGB(35, 35, 48)
        ...
        function Components:NewTextbox(text, default, place, format, type, autoexec, autoclear, callback)
            ...
            if type == "small" then
                ...
                textBoxValues.Focused:Connect(function()
                    textBoxValues:GetPropertyChangedSignal("Text"):Connect(ResizeTextBox)
                    TweenService:Create(textbox, TweenTable["TextBox"], {BackgroundColor3 = Color3.fromRGB(66, 109, 135)}):Play()
                end)

                textBoxValues.FocusLost:Connect(function()
                    TweenService:Create(textbox, TweenTable["TextBox"], {BackgroundColor3 = Color3.fromRGB(35, 35, 48)}):Play()
                end)
        ...
        function Components:NewSelector(text, default, list, callback)
            ...
            selector.BackgroundColor3 = Color3.fromRGB(35, 35, 48)
            ...
            for i,v in next, list do
                ...
                if optionButton.Text == default then
                    optionButton.TextColor3 = Color3.fromRGB(66, 109, 135)
                ...
                optionButton.MouseButton1Click:Connect(function()
                    ...
                    TweenService:Create(optionButton, TweenTable["selector"], {TextColor3 = Color3.fromRGB(66, 109, 135)}):Play()
        ...
        function Components:NewSlider(text, suffix, compare, compareSign, values, callback)
            ...
            sliderButton.BackgroundColor3 = Color3.fromRGB(35, 35, 48)
            ...
            sliderIndicatorGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(66, 109, 135)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(128, 94, 208))}
